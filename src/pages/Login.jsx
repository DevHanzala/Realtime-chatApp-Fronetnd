...
import { Mail, Lock, ArrowLeft, LogIn, Loader2 } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-linear-to-br from-slate-50 via-blue-50 to-indigo-100 px-4 py-8 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-40 right-10 w-64 sm:w-72 h-64 sm:h-72 bg-blue-200 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-blob animation-delay-2000"></div>
        <div className="absolute -bottom-8 left-1/2 w-64 sm:w-72 h-64 sm:h-72 bg-purple-200 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-blob animation-delay-4000"></div>
      </div>
      ...
      <div className="relative z-10 w-full max-w-md animate-fadeInUp">
        ...
        <div className="bg-white bg-opacity-95 backdrop-blur-xl p-6 sm:p-8 md:p-10 rounded-3xl shadow-2xl border border-white border-opacity-30 hover:shadow-indigo-200 hover:shadow-opacity-50 transition-all duration-500">
          ...
          <div className="text-center mb-8 animate-fadeIn">
            ...
            <p className="text-sm sm:text-base text-slate-600">Sign in to continue your conversations</p>
          </div>
          ...
          <button 
            ...
            type="button"
            className="w-full bg-white border-2 border-slate-300 text-slate-700 py-3 rounded-xl hover:bg-slate-50 hover:border-slate-400 hover:shadow-lg transition-all duration-300 font-medium flex items-center justify-center gap-3 group disabled:opacity-70 disabled:cursor-not-allowed"
          >
            {isGoogleLoading ? (
              <>
